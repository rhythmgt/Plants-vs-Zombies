...
public class NormalZombie extends Zombie implements Serializable {
    NormalZombie(double i, AnchorPane parent, ArrayList<Transition> animations, ArrayList<Plant> Enemies) {
        super((int)i);
    ...
    void moveZombie(ArrayList<Transition> animations, ArrayList<Plant> Enemies){
        Transition movingTransition= this.new moveZombieAnimation(myImg.getLayoutX(), myImg.getLayoutX()-900, Enemies);
